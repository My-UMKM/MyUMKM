...
class SectionViewModelFactory private constructor(private val sectionRepository: SectionRepository,private val accountRepository: AccountRepository) :
    ViewModelProvider.Factory {
    @Suppress("UNCHECKED_CAST")
    override fun <T : ViewModel> create(modelClass: Class<T>): T =
        when {
            modelClass.isAssignableFrom(SectionViewModel::class.java) -> {
                SectionViewModel(sectionRepository, accountRepository) as T
            }
